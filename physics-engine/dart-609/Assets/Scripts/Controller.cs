    ...
    void FixedUpdate()
    {
        ...
        if (isLaunched && !moveDart.hitBoard)
        {
            ...
            timeSeries.Add(new TimeSeriesData
            {
                ...
                DartAccelerationY = Physics.gravity.y,
                DartAccelerationZ = 0, 
                BoardAccelerationY = Physics.gravity.y,
                BoardAccelerationZ = 0 
            });
...
public class TimeSeriesData
{
    ...
    public static string Header()
    {
        return "t, y_Dart, z_Dart, y_Board, z_Board, " +
               "vy_Dart, vz_Dart, vy_Board, vz_Board, " +
               "ay_Dart, az_Dart, ay_Board, az_Board";
    }
}
