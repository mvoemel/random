...
public class ResponseWriter {
     ...
     */
    public static void writeResponse(final BufferedWriter outputStream, final Response response) {
        try {
            final int statusCode = response.getStatusCode();
            final String statusCodeMeaning = StatusCode.fromCode(statusCode).name();
