...
public class Response {
     ...
     */
    private Response(final Map<String, List<String>> responseHeaders, final int statusCode, final Optional<Object> entity) {
    ...
    public static class Builder {
        ...
        public Response build() {
            return new Response(responseHeaders, statusCode, entity);
        }
    }
}